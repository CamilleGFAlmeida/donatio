<?php
    ...
    class cadastroj
    {
        ...
        public function inserir()
        {
            ...
            try {
                $comando=$conexao->prepare("insert into pessoaj(cnpj,nome,cep,numero,complemento,ddd,tel,email,senha,datacriacao) values(?,?,?,?,?,?,?,?,?,?)");
                ...
                $comando->bindParam(9,$this->senha);
                $comando->bindParam(10,$data);
